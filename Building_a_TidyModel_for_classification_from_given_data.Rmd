...
print(strand_fitted)
datatable(strand_fitted,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
...
datatable(lr_predictions,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
...
print(rf_fit_rs)
datatable(rf_fit_rs,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
```
...
datatable(rf_resample_mean_preds,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
...
datatable(grid_tree_tune,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
```
...
print(best_tree)
datatable(best_tree,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
...
xgboost_grid
datatable(xgboost_grid,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
...
datatable(xgboost_tuned,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
...
print(xgboost_score)
datatable(xgboost_score,extensions = 'Buttons',
options = list(dom='Bfrtip',
buttons=c('copy', 'csv', 'excel', 'print', 'pdf')))
...
library(ConfusionTableR)
cm <- ConfusionTableR::binary_visualiseR(
  train_labels = test_prediction$.pred_class,
  truth_labels = test_prediction$result_code,
  class_label1 = "No Surgery", 
  class_label2 = "Surgery",
  quadrant_col1 = "#28ACB4", 
  quadrant_col2 = "#4397D2", 
  custom_title = "Patient Confusion Matrix", 
  text_col= "black",
  cm_stat_size = 1.2,
  round_dig = 2)

cm_outputs$record_level_cm

# data.table::fwrite(cm_outputs$record_level_cm,
#                    file=paste0("Data/xgboost_results_", as.character(Sys.time()), ".csv"))
